...
- rocWMMA is hosted and maintained by AMD on `GitHub  <https://github.com/ROCm/rocm-libraries>`_ in the `projects/rocwmma directory <https://github.com/ROCm/rocm-libraries/tree/develop/projects/rocwmma>`_.
