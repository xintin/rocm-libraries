...
run `./install -c` in the rocBLAS source directory. See [rocBLAS build](https://rocm.docs.amd.com/projects/rocBLAS/en/latest/index.html) for more information.
